...
export function HeroSection() {
  return (
    <section className="theme-obsidian relative overflow-hidden bg-surface">
      ...
      <div className="relative mx-auto max-w-6xl px-5 py-15 sm:px-8 sm:py-24 lg:px-12 lg:py-30">
        <div className="relative min-h-[50vh] sm:min-h-[calc(75vh-5.25rem)] lg:min-h-[calc(75vh-4rem)]">
          {/* Content - Left side */}
